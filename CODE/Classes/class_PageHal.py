...
class PageHAL:
    def __init__(self, start_year=None, end_year=None, language='en', author=None, size=None):
    ...
    @url.setter
    def url(self, x):
        self.__url = PageHAL.generate_url(self.start_year, self.end_year,
                                          self.language, self.author, self.size)
        if x != "edit":
            print("you cant modify the url")

    @staticmethod
    def generate_url(pstart, pend, language, author, size):
